...
router.get("/signup", validator.body(authSchema.SignUpSchema2), ctrl.SignUp);
...
router.post("/submitpassword", validator.body(authSchema.SubmtOtpPassSchema), passport.authenticate("jwt", { session: false }), ctrl.SubmitPassword);
